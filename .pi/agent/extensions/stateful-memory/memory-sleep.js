...
function buildWakeTask({ recencyIndexFile, observationsFile, wakeFile }) {
  return [
    ...
    "This is a JSON array of recent sessions, each with a tagmemEntryId, timestamp,",
    "and tags. It tells you what sessions have happened recently and in what order.",
    "",
